...
def main():
        ...
        qubo, num_vars, hamiltonian, offset = _qubo_converter(mip, penalty=1e9)
        ...
        qpu = DWaveSampler()
        sampleset = EmbeddingComposite(qpu).sample(bqm_binary,
        ...
        #sampleset = sampler.sample(bqm_binary, label='Example - CM',time_limit=10)
