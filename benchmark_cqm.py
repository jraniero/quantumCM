...
def solveBQM(cqm,inspect=False,num_reads=1000,annealing_time=40,benchmarkCQM=None,chain_strength=None):
      ...
      print(solution)
      print("Is feasible: {}".format(cqm.check_feasible(solution.sample)))
      if benchmarkCQM:
           print("Is feasible benchamrk: {}".format(benchmarkCQM.check_feasible(solution.sample)))
